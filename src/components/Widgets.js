...
export const CounterWidget = (employees) => {
  const { t } = useTranslation();
  let checkObject=employees;
  let employeesData =employees.hasOwnProperty('employee') && Array.isArray(employees['employee']);
  if(employeesData){
    employeesData=employees.employee;
  const countMaleEmployees = () => {
    return employeesData.filter(employee => employee.gender === 'm').length;
  };

  const countFemaleEmployees = () => {
    return employeesData.filter(employee => employee.gender === 'f').length;
  };
        ...
        <Row className="d-block d-xl-flex align-items-center">
          <Col xl={12} className="px-xl-0">
            <div className="d-none d-sm-block">
              <h5> {t('total')}</h5>
              <h3 className="mb-1">{countTotalEmployees()}</h3>
            </div>
          </Col>
        </Row>
      </Card.Body>
      ...
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          <Col xl={12} className="px-xl-0">
            <div className="d-none d-sm-block">
              <h5>{t('male')}</h5>
              <h3 className="mb-1">{countMaleEmployees()}</h3>
            </div>
          </Col>
        </Row>
      </Card.Body>
      ...
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          <Col xl={12} className="px-xl-0">
            <div className="d-none d-sm-block">
              <h5>{t('female')}</h5>
              <h3 className="mb-1">{countFemaleEmployees()}</h3>
            </div>
          </Col>
        </Row>
      </Card.Body>
